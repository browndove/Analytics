    ...
    return (
        <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center gap-4">
                {/* Search Bar */}
                <div className="flex items-center gap-2 bg-primary rounded-full px-4 py-2 w-[280px] border border-tertiary">
                ...
                {/* User Avatar */}
                <div className="flex items-center gap-2 cursor-pointer bg-white rounded-full pl-1 pr-3 py-1">
                    <Image
