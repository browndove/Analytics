...
const Dropdown = ({
    ...
    return (
        <div className={clsx('relative', className)} ref={wrapperRef}>
            ...
            {open && (
                <div className="absolute right-0 mt-2 bg-primary border border-tertiary rounded-[10px] shadow-soft py-1 overflow-hidden min-w-[160px] z-50">
                        ...
                        {options.map((option) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={clsx(
                                        'w-full text-left px-3 py-2.5 flex items-center justify-between gap-3 transition-colors duration-150',
