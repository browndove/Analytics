...
type SubscriptionCardProps = {
    badge: string;
    badgeColor: "purple" | "teal" | "coral" | "green";
    title: string;
    provider: string;
    amount: string;
    currency?: string;
...
const SubscriptionCard: React.FC<SubscriptionCardProps> = ({
    ...
    const parsedValue = React.useMemo(() => parseValue(amount), [amount]);
    ...
    const tooltipContent =
        infoText || `${title} subscription from ${provider}. Next payment on ${nextPaymentDate}.`;
        ...
        >
            ...
            <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <span className="inline-flex px-2 py-0.5 rounded-[6px] bg-accent-primary/10 text-[11px] font-medium w-fit text-accent-primary">
                        {provider}
                    </span>
                </div>
            </div>
            <div className="mt-1 flex flex-col gap-2">
                <span className={clsx(
                    ...
                    {currency} {formatNumber(animatedNumber, parsedValue.decimals)}
                </span>
